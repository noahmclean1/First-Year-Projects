           ...
           [((Loc r1 c1) (Loc r2 c2))
            (cond
              ...
              [(and
                ...
                (symbol=? 'Black p)) #t]
              [else #f])]))]))
(check-expect (pawn-attack-range? (Loc 6 0) 'White (Loc 5 1) starting-board) #f)
(check-expect (pawn-attack-range? (Loc 4 4) 'White (Loc 3 3) testboard1) #t)
(check-expect (pawn-attack-range? (Loc 3 2) 'Black (Loc 4 3) testboard2) #t)
